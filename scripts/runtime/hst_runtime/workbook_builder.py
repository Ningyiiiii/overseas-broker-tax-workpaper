...
# 计算方法: USD/HKD = (USD/CNY) / (HKD/CNY)
# 数据来源: 中国人民银行授权中国外汇交易中心公布的汇率中间价
# 期间截止日非工作日的，采用最近前一工作日的中间价
PBOC_FX_RATES = {
    "2021-12-31": 7.8051,   # 原有
    "2022-03-31": 7.8315,   # 原有
    "2022-12-31": 7.8087,   # 原有（2022-12-30 实际发布）
    "2023-03-31": 7.8495,   # 原有
    "2024-03-31": 7.8265,   # 2024-03-29 中间价: USD=7.0950, HKD=0.90655
    "2024-12-31": 7.7639,   # 2024-12-31 中间价: USD=7.1884, HKD=0.9260
    "2025-03-31": 7.7789,   # 2025-03-31 中间价: USD=7.1782, HKD=0.92283
    "2025-12-31": 7.7816,   # 2025-12-31 中间价: USD=7.0288, HKD=0.90322
    "2026-03-31": 7.8365,   # 2026-03-31 中间价: USD=6.9194, HKD=0.88295
}
